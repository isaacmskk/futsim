<template>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <tbody class="row">
              <tr v-for="(jugador, index) in jugadores" :key="index" class="card col-4 cartJugadores text-center">
                <td class="p-2">
  ...
  const guardarJugadoresSeleccionados = () => {
    // Envía una solicitud para guardar jugadoresSeleccionados en la base de datos
